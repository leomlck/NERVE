...
data_path = '/midtier/sablab/scratch/lem4012/data/rbc-data-hr/'

# Output configuration: set the folder where you want to save the feature CSV
# and the desired CSV file name.
path_to_features = '/midtier/sablab/scratch/lem4012/save/fc_mae_features'  # Change as needed.
output_csv_filename = 'features_fc_mae_RBC_FC_FC_enc_FC_dec_nw_p1_RBC_avg.csv'
