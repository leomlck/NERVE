...
s = 100
ext = '_Kong22'
input_dir = f"/ministorage/RBC/FC_results/CCNP_schaefer{s}_17Net_order"+ext
output_dir = f"/midtier/sablab/scratch/lem4012/data/ccnp-data-hr-{s}"+ext

# Create the output directory if it doesn't exist
os.makedirs(output_dir, exist_ok=True)

# Regex to match files like "sub-colornest001_combined_fc.mat"
pattern = re.compile(r"sub-(colornest\d+)_combined_fc\.mat$")
