...
# ---------------- Configuration ----------------
# Input directory where the HCPD .pt files are stored.
data_path = '/midtier/sablab/scratch/lem4012/data/hcpd-data-hr/'
...
output_csv_filename = 'features_fc_mae_HCPD_FC_FC_enc_FC_dec_nw_p1_HCPD_avg.csv'

# Create the output directory if it does not exist.
os.makedirs(path_to_features, exist_ok=True)

# ----------------- Setup -----------------
# Regex pattern: expecting filenames like "sub-HCD1227740_fc.pt" to extract the subject ID.
